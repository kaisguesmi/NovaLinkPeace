...
function handleSendMessage($messageModel) {
    ...
    $success = $messageModel->sendMessage($idExpert, $idClient, $contenu, $idHistoire, 'expert');
...
function handleReplyMessage($messageModel) {
    ...
    if ($role === 'expert') {
        ...
        $success = $messageModel->sendMessage($idExpert, $idClient, $contenu, null, 'expert');
        ...
        $success = $messageModel->sendMessage($idExpert, $idClient, $contenu, null, 'client');
