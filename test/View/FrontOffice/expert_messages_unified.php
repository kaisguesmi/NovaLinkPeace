...
<body>
    ...
    <div class="messages-container">
        <div class="page-header">
            ...
            <p>Contactez les clients via leurs histoires ou continuez vos conversations (maximum 5 messages par conversation)</p>
        </div>
                        ...
                        <div class="conversation-card">
                            ...
                            <div class="messages-list" id="messages-<?= $conv['id_conversation'] ?>">
                                <?php foreach ($messages as $msg): ?>
                                    <div class="message <?= $msg['id_expert'] == $idExpert ? 'message-expert' : 'message-client' ?>">
                                        <div class="message-avatar">
                                            <?= strtoupper(substr($msg['id_expert'] == $idExpert ? $msg['expert_nom'] : $msg['client_nom'], 0, 1)) ?>
                                        </div>
                            ...
                            <?php if ($conv['statut'] === 'ouverte' && $conv['message_count'] < 5): ?>
                            ...
                            <?php else: ?>
                                <div style="text-align: center; padding: 15px; background: #f8d7da; border-radius: 8px; color: #721c24;">
                                    <i class="fas fa-lock"></i> Cette conversation est fermée (5 messages atteints)
                                </div>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
